...
function App() {
  ...
  <div className="animate__animated animate__fadeInUp animate__delay-3s">
    ...
    <div className="flex items-center sm:gap-4 gap-2">
      <a 
        href="/assets/RaviKrishnaCV.pdf" 
        download="RaviKrishnaCV.pdf"
      ...
      <div key={proyek.id} className="p-4 bg-zinc-800 rounded-md" data-aos="fade-up" data-aos-duration="1000" data-aos-delay={proyek.dad} data-aos-once="true">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            /* names youtube tumbnail down onces */  <p className="py-1 px-3 border border-zinc-500 bg-zinc-600 rounded-md font-semibold" key={index}>{tool}</p>
            ))}
          </div>
